package sg.edu.rp.c346.id19020303.demomap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment)
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng point_CauseWayPoint = new LatLng(1.435983, 103.785688);
                Marker cp = map.addMarker(new
                        MarkerOptions()
                        .position(point_CauseWayPoint)
                ...
                map.moveCamera(CameraUpdateFactory.newLatLngZoom(point_CauseWayPoint,15));
